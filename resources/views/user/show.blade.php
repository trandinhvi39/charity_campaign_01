                        ...
                        <div class="profile-content">
                            @foreach ($actions as $action)
                                ...
                                @elseif ($action->action_type == config('constants.ACTION.CLOSE_CAMPAIGN'))
                                    ...
                                    @php ($campaign = $action->actionable->campaign($action->actionable->id))
                                @elseif ($action->action_type == config('constants.ACTION.COMMENT_CAMPAIGN'))
                                    @php ($message = trans('campaign.action_comment_campaign'))
                                    @php ($campaign = $action->actionable->campaign($action->actionable->id))
                                            ...
                                            <p>
                                                @if ($action->action_type == config('constants.ACTION.ACTIVE_CAMPAIGN'))
                                                    ...
                                                    @if (auth()->id() == $action->user_id)
                                                        <i class="label label-success">{{ trans('user.you') . ' ' . $message }}</i>
                                                    @else
                                                        <i class="label label-success">{{ $action->user($action->user_id)->name . ' ' . $message }}</i>
                                                    @endif
                                                @elseif ($action->action_type == config('constants.ACTION.CLOSE_CAMPAIGN'))
                                                    <span class="glyphicon glyphicon-menu-right"></span>
                                                    @if (auth()->id() == $action->user_id)
                                                        <i class="label label-danger">{{ trans('user.you') . ' ' . $message }}</i>
                                                    @else
                                                        <i class="label label-danger">{{ $action->user($action->user_id)->name . ' ' . $message }}</i>
                                                    @endif
                                                @elseif ($action->action_type == config('constants.ACTION.COMMENT_CAMPAIGN'))
                                                    <span class="glyphicon glyphicon-menu-right"></span>
                                                    @if (auth()->id() == $action->user_id)
                                                        <i class="label label-primary">{{ trans('user.you') . ' ' . $message }}</i>
                                                    @else
                                                        <i class="label label-primary">{{ $action->user($action->user_id)->name . ' ' . $message }}</i>
                                                    @endif
                                                @else
                                                    <span class="glyphicon glyphicon-menu-right"></span>
                                                    @if (auth()->id() == $action->user_id)
                                                        <i class="label label-warning">{{ trans('user.you') . ' ' . $message }}</i>
                                                    @else
                                                        <i class="label label-warning">{{ $action->user($action->user_id)->name . ' ' . $message }}</i>
                                                    @endif
                                                @endif
                                    ...
                                    @else
                                        <div class="block-content-full">
                                            <div class="timeline">
                                                <ul class="timeline-list">
                                                    <li class="active">
                                                        <div class="timeline-icon"><i class="glyphicon glyphicon-menu-right"></i></div>
                                                        <div class="timeline-time">
